...
namespace Tests
{
    ...
    {
        [Test]
        public void Mapper_FillObject_int()
        {
            ...
            {
                result = Mapper.FillObject<TestObject>(dataTable);
            });
        ...
        [Test]
        public void Mapper_FillObject_string()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_datetime()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_binary()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_binary_to_Array()
        {
            var dataTable = new DataTable("ObjectTable");
            var colValue = Encoding.ASCII.GetBytes("Hello This is test");
        ...
        [Test]
        public void Mapper_FillObject_bit()
        {
            var dataTable = new DataTable("ObjectTable");
            var colValue = true;
        ...
        [Test]
        public void Mapper_FillObject_decimal()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_int_to_boolean_true()
        {
            var dataTable = new DataTable("ObjectTable");
            decimal colValue = 1;
        ...
        [Test]
        public void Mapper_FillObject_int_to_boolean_false()
        {
            var dataTable = new DataTable("ObjectTable");
            decimal colValue = 0;
        ...
        [Test]
        public void Mapper_FillObject_guid()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_enum()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_1_Items()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_500_Items()
        {
            var dataTable = new DataTable("ObjectTable");
            ...
            {
                result = Mapper.FillCollection<TestObject>(dataTable);
            });
        ...
        [Test]
        public void Mapper_FillObject_5000_Items()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_50000_Items()
        {
            var dataTable = new DataTable("ObjectTable");
        ...
        [Test]
        public void Mapper_FillObject_CallbackTest()
        {
            var dataTable = new DataTable("ObjectTable");
            ...
            {
                result = Mapper.FillObject<TestObject>(dataTable, (T) =>
                {
                    T.StringProp = "blah";
                });
            });
        ...
        [Test]
        public void Mapper_FillObject_1_Existing_Items()
        {
            var dataTable = new DataTable("ObjectTable");
            ...
            {
                result = Mapper.FillObject<TestObject>(dataTable, new TestObject { StringProp = "Don't Overwrite Me!" }, false);
            });
        ...
        [Test]
        public void Mapper_FillObject_1_Existing_Items_With_Overwrite()
        {
            var dataTable = new DataTable("ObjectTable");
            ...
            {
                result = Mapper.FillObject<TestObject>(dataTable, new TestObject { IntProp = 1, StringProp = "Overwrite Me!", DateTimeProp = DateTime.Today.AddDays(-1) }, true);
            });
        ...
        [Test]
        public void Mapper_FillObject_1_Existing_Items_With_Callback()
        {
            var dataTable = new DataTable("ObjectTable");
            ...
            {
                result = Mapper.FillObject<TestObject>(dataTable, new TestObject(), false, (T) => { T.ModifyItems(); });
            });
        ...
        [Test]
        public void Mapper_FillLargeObject_50000_Items()
        {
            var dataTable = new DataTable("ObjectTable");
            ...
            {
                result = Mapper.FillCollection<TestLargeObject>(dataTable);
            });
